...
$CFG->dbname    = 'beforeprod';     // database name, eg moodle
$CFG->dbuser    = 'root';   // your database username
$CFG->dbpass    = 'photon';   // your database password
...
$CFG->passwordsaltmain = '!t)K_*uO+t{Ro;3Fe~E<a<]0C';
//
...
$CFG->wwwroot   = 'http://172.16.17.42/cliniquelatest/admin';
...
$CFG->dataroot  = '/mnt/moodledataqa';

$CFG->sessiontimeout = 1209600;
