...
/// Now actually print the appropriate button.
	...
	<script language="JavaScript" type="text/javascript">
		$(document).ready(function() {
			$('.clsGameAttempt').click(function() {
				$('.clsGameAttempt .ui-btn').addClass("ui-btn-active");
			});
		});
	</script>
	<style type="text/css">
    ...
    /// Show the start button, in a div that is initially hidden.
        echo '<div id="gamestartbuttondiv" class="clsGameCrosswd">';
        $url = new moodle_url($CFG->wwwroot.'/mod/game/attempt.php', array('id' => $id));
        $button = new single_button($url, $buttontext);
		$button->class = "clsGameAttempt";
