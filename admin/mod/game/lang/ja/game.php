...
$string[ 'and'] = 'そして';
$string[ 'cross_correct'] = '正しい';
$string[ 'cross_corrects'] = 'を補正';
$string[ 'cross_error'] = 'エラー';
$string[ 'cross_errors'] = 'エラーが';
$string[ 'cross_found_many'] = '見つかった';
$string[ 'cross_found_one'] = '見つかった';
$string[ 'grade'] = 'グレード';

//cross/play.php
$string[ 'cross_across'] = '越えて';
$string[ 'cross_checkbutton'] = 'クロスワードをチェック';
$string[ 'cross_down'] = 'ダウン';
$string[ 'cross_endofgamebutton'] = '終盤';
$string[ 'cross_error_containsbadchars'] = '言葉は違法characteresが含まれています';
$string[ 'cross_error_wordlength1'] = '正しい単語が含まれています ';
$string[ 'cross_error_wordlength2'] = ' 手紙.';
$string[ 'cross_pleasewait'] = 'クロスロードがあるまでお待ちください';
$string[ 'cross_welcome'] = '<h3>歓迎!</h3><p>開始するには単語をクリック.</p>';
$string[ 'letter'] = '手紙';
$string[ 'letters'] = '手紙';
$string[ 'nextgame'] = '新しいゲーム';
$string[ 'no_words'] = '言葉がありません';
$string[ 'print'] = '印刷';
$string[ 'win'] = '祝辞 !!!';
...
//view.php
$string[ 'attemptgamenow'] = '今試みゲーム';
$string[ 'comment'] = 'Comment';
$string[ 'continueattemptgame'] = 'ゲームの以前の試みを続ける';
