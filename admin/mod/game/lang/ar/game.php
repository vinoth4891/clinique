...
$string[ 'and'] = 'و';
$string[ 'cross_correct'] = 'صحيح';
$string[ 'cross_corrects'] = 'يصحح';
$string[ 'cross_error'] = 'خطأ';
$string[ 'cross_errors'] = 'أخطاء';
$string[ 'cross_found_many'] = 'وجدت';
$string[ 'cross_found_one'] = 'وجدت';
$string[ 'grade'] = 'الصف';

//cross/play.php
$string[ 'cross_across'] = 'عبر';
$string[ 'cross_checkbutton'] = 'مراجعة الكلمات المتقاطعة';
$string[ 'cross_down'] = 'أسفل';
$string[ 'cross_endofgamebutton'] = 'نهاية لعبة';
$string[ 'cross_error_containsbadchars'] = 'كلمة تحتوي characteres غير قانونية';
$string[ 'cross_error_wordlength1'] = 'تحتوي الكلمة الصحيحة ';
$string[ 'cross_error_wordlength2'] = ' رسائل.';
$string[ 'cross_pleasewait'] = 'يرجى الانتظار بينما الصليب هو تحميل';
$string[ 'cross_welcome'] = '<h3>ترحيب!</h3><p>انقر على كلمة واحدة لبدء.</p>';
$string[ 'letter'] = 'الرسالة';
$string[ 'letters'] = 'رسائل';
$string[ 'nextgame'] = 'لعبة جديدة';
$string[ 'no_words'] = 'لا توجد كلمات';
$string[ 'print'] = 'طباعة';
$string[ 'win'] = 'مبروك !!!';
...
$string[ 'timetaken'] = 'الوقت الذي يستغرقه';
...
//view.php
$string[ 'attemptgamenow'] = 'محاولة اللعبة الآن';
$string[ 'comment'] = 'Comment';
$string[ 'continueattemptgame'] = 'مواصلة محاولة سابقة من اللعبة';
...
$string[ 'reattemptgame'] = 'إعادة اللعبة محاولة';
