...
$string[ 'and'] = 'dan';
$string[ 'cross_correct'] = 'benar';
$string[ 'cross_corrects'] = 'mengoreksi';
$string[ 'cross_error'] = 'error';
$string[ 'cross_errors'] = 'kesalahan';
$string[ 'cross_found_many'] = 'ditemukan';
$string[ 'cross_found_one'] = 'ditemukan';
$string[ 'grade'] = 'kelas';

//cross/play.php
$string[ 'cross_across'] = 'Di seberang';
$string[ 'cross_checkbutton'] = 'Periksa Crossword';
$string[ 'cross_down'] = 'bawah';
$string[ 'cross_endofgamebutton'] = 'akhir Permainan';
$string[ 'cross_error_containsbadchars'] = 'Kata berisi characteres ilegal';
$string[ 'cross_error_wordlength1'] = 'Kata yang benar berisi ';
$string[ 'cross_error_wordlength2'] = ' surat.';
$string[ 'cross_pleasewait'] = 'Harap tunggu sementara salib loading';
$string[ 'cross_welcome'] = '<h3>Selamat!</h3><p>Klik pada sebuah kata untuk memulai.</p>';
$string[ 'letter'] = 'surat';
$string[ 'letters'] = 'surat';
$string[ 'nextgame'] = 'permainan baru';
$string[ 'no_words'] = 'Tidak ada kata-kata';
$string[ 'print'] = 'Cetak';
$string[ 'win'] = 'Selamat !!!';
...
//view.php
$string[ 'attemptgamenow'] = 'Mencoba game sekarang';
$string[ 'comment'] = 'Comment';
$string[ 'continueattemptgame'] = 'Lanjutkan upaya sebelumnya dari permainan';
