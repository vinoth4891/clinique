...
//cross/play.php
$string[ 'cross_across'] = '橫過';
$string[ 'cross_checkbutton'] = '檢查填字遊戲';
$string[ 'cross_down'] = '下';
$string[ 'cross_endofgamebutton'] = '遊戲結束';
$string[ 'cross_error_containsbadchars'] = '此词含有非法字符';
$string[ 'cross_error_wordlength1'] = '正確的字包含';
...
//view.php
$string[ 'attemptgamenow'] = '現在嘗試的遊戲';
$string[ 'continueattemptgame'] = '繼續遊戲的上一次嘗試';
$string[ 'reattemptgame'] = '重新嘗試遊戲';
