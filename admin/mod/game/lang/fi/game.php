...
$string[ 'and'] = 'ja';
$string[ 'cross_correct'] = 'oikein';
$string[ 'cross_corrects'] = 'korjaa';
$string[ 'cross_error'] = 'virhe';
$string[ 'cross_errors'] = 'virheet';
$string[ 'cross_found_many'] = 'löytyi';
$string[ 'cross_found_one'] = 'löytyi';
$string[ 'grade'] = 'luokka';

//cross/play.php
$string[ 'cross_across'] = 'Across';
$string[ 'cross_checkbutton'] = 'Tarkista sanaristikko';
$string[ 'cross_down'] = 'alas';
$string[ 'cross_endofgamebutton'] = 'end Game';
$string[ 'cross_error_containsbadchars'] = 'Sana on kiellettyjä characteres';
$string[ 'cross_error_wordlength1'] = 'Oikea sana sisältää ';
$string[ 'cross_error_wordlength2'] = ' kirjeet.';
$string[ 'cross_pleasewait'] = 'Odota, kun rajat on lastaus';
$string[ 'cross_welcome'] = '<h3>Tervetuloa!</h3><p>Klikkaa sana alkaa.</p>';
$string[ 'letter'] = 'kirje';
$string[ 'letters'] = 'kirjeet';
$string[ 'nextgame'] = 'uusi peli';
$string[ 'no_words'] = 'Ei ole sanoja';
$string[ 'print'] = 'Tulosta';
$string[ 'win'] = 'Onnittelut !!!';
...
//view.php
$string[ 'attemptgamenow'] = 'Yritys peli nyt';
$string[ 'comment'] = 'Comment';
$string[ 'continueattemptgame'] = 'Jatka aiemmalla kerralla peli';
...
$string[ 'reattemptgame'] = 'reattempt peli';
