...
$string[ 'and'] = 'og';
$string[ 'cross_correct'] = 'korrekt';
$string[ 'cross_corrects'] = 'korrigerer';
$string[ 'cross_error'] = 'fejl';
$string[ 'cross_errors'] = 'fejl';
$string[ 'cross_found_many'] = 'fundet';
$string[ 'cross_found_one'] = 'fundet';
$string[ 'grade'] = 'Grade';

//cross/play.php
$string[ 'cross_across'] = 'tværs';
$string[ 'cross_checkbutton'] = 'Tjek Krydsord';
$string[ 'cross_down'] = 'ned';
$string[ 'cross_endofgamebutton'] = 'Afslut spil';
$string[ 'cross_error_containsbadchars'] = 'Ordet indeholder ulovlige characteres';
$string[ 'cross_error_wordlength1'] = 'Det korrekte ord indeholder ';
$string[ 'cross_error_wordlength2'] = ' breve.';
$string[ 'cross_pleasewait'] = 'Vent venligst mens korset er loading';
$string[ 'cross_welcome'] = '<h3>velkommen!</h3><p>Klik på et ord for at begynde.</p>';
$string[ 'letter'] = 'brev';
$string[ 'letters'] = 'breve';
$string[ 'nextgame'] = 'nyt spil';
$string[ 'no_words'] = 'Der er ingen ord';
...
$string[ 'timecompleted'] = 'afsluttet';
...
$string[ 'timetaken'] = 'tid, det tager';
...
$string[ 'continueattemptgame'] = 'Fortsæt et tidligere forsøg på spil';
