...
$string[ 'and'] = 'és';
$string[ 'cross_correct'] = 'helyes';
$string[ 'cross_corrects'] = 'korrigál';
$string[ 'cross_error'] = 'hiba';
$string[ 'cross_errors'] = 'hibák';
$string[ 'cross_found_many'] = 'talált';
$string[ 'cross_found_one'] = 'talált';
$string[ 'grade'] = 'fokozat';

//cross/play.php
$string[ 'cross_across'] = 'Across';
$string[ 'cross_checkbutton'] = 'Ellenőrizze a keresztrejtvény';
$string[ 'cross_down'] = 'Down';
$string[ 'cross_endofgamebutton'] = 'end Game';
$string[ 'cross_error_containsbadchars'] = 'A szó tartalmaz illegális characteres';
$string[ 'cross_error_wordlength1'] = 'A helyes szó tartalmazza ';
$string[ 'cross_error_wordlength2'] = ' levelek.';
$string[ 'cross_pleasewait'] = 'Várjon, amíg a kereszt loading';
$string[ 'cross_welcome'] = '<h3>Üdvözöljük!</h3><p>Kattints egy szót kezdődik.</p>';
$string[ 'letter'] = 'levél';
$string[ 'letters'] = 'levelek';
$string[ 'nextgame'] = 'új játék';
$string[ 'no_words'] = 'Nincsenek szavak';
$string[ 'print'] = 'Nyomtatás';
$string[ 'win'] = 'Gratulálok !!!';
...
//view.php
$string[ 'attemptgamenow'] = 'Kísérlet játék most';
$string[ 'comment'] = 'Comment';
$string[ 'continueattemptgame'] = 'Tovább a korábbi kísérlet játék';
...
$string[ 'reattemptgame'] = 'új megpróbálhat játék';
