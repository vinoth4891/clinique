...
$string[ 'and'] = '및';
$string[ 'cross_correct'] = '올바른';
$string[ 'cross_corrects'] = '보정하는';
$string[ 'cross_error'] = '오류';
$string[ 'cross_errors'] = '오류';
$string[ 'cross_found_many'] = '발견';
$string[ 'cross_found_one'] = '발견';
$string[ 'grade'] = '등급';

//cross/play.php
$string[ 'cross_across'] = '간';
$string[ 'cross_checkbutton'] = '크로스 워드 퍼즐을 확인';
$string[ 'cross_down'] = '아래로';
$string[ 'cross_endofgamebutton'] = '엔드 게임';
$string[ 'cross_error_containsbadchars'] = '이 단어는 불법 characteres을 포함';
$string[ 'cross_error_wordlength1'] = '올바른 단어는 포함 ';
$string[ 'cross_error_wordlength2'] = ' 편지.';
$string[ 'cross_pleasewait'] = '크로스가 완전히로드 될 때까지 기다려주십시오';
$string[ 'cross_welcome'] = '<h3>에 오신 것을 환영합니다!</h3><p>시작하는 단어를 클릭.</p>';
$string[ 'letter'] = '편지';
$string[ 'letters'] = '편지';
$string[ 'nextgame'] = '새로운 게임';
$string[ 'no_words'] = '어떤 단어가 없습니다';
$string[ 'print'] = '인쇄';
$string[ 'win'] = '축하합니다 !!!';
...
//view.php
$string[ 'attemptgamenow'] = '지금 시도 게임';
$string[ 'comment'] = 'Comment';
$string[ 'continueattemptgame'] = '게임의 이전 시도를 계속';
