...
$string[ 'and'] = 'và';
$string[ 'cross_correct'] = 'chính xác';
$string[ 'cross_corrects'] = 'sửa chữa';
$string[ 'cross_error'] = 'lỗi';
$string[ 'cross_errors'] = 'lỗi';
$string[ 'cross_found_many'] = 'Found';
$string[ 'cross_found_one'] = 'Found';
$string[ 'grade'] = 'Grade';

//cross/play.php
$string[ 'cross_across'] = 'qua';
$string[ 'cross_checkbutton'] = 'Kiểm tra ô chữ';
$string[ 'cross_down'] = 'xuống';
$string[ 'cross_endofgamebutton'] = 'Kết thúc trò chơi';
$string[ 'cross_error_containsbadchars'] = 'Từ chứa characteres bất hợp pháp';
$string[ 'cross_error_wordlength1'] = 'Từ đúng chứa ';
$string[ 'cross_error_wordlength2'] = ' thư.';
$string[ 'cross_pleasewait'] = 'Hãy đợi chéo là tải';
$string[ 'cross_welcome'] = '<h3>Chào mừng!</h3><p>Nhấp vào một từ để bắt đầu.</p>';
$string[ 'letter'] = 'thư';
$string[ 'letters'] = 'thư';
$string[ 'nextgame'] = 'trò chơi mới';
$string[ 'no_words'] = 'Không có từ ngữ';
$string[ 'print'] = 'In';
$string[ 'win'] = 'Xin chúc mừng !!!';
...
//view.php
$string[ 'attemptgamenow'] = 'Nỗ lực trò chơi bây giờ';
$string[ 'comment'] = 'Comment';
$string[ 'continueattemptgame'] = 'Tiếp tục một nỗ lực trước đó của trò chơi';
...
$string[ 'reattemptgame'] = 'thực hiện lại quá trò chơi';
