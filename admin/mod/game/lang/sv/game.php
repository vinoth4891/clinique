...
$string[ 'cross_corrects'] = 'korrigerar';
$string[ 'cross_error'] = 'fel';
$string[ 'cross_errors'] = 'fel';
$string[ 'cross_found_many'] = 'Funnet';
$string[ 'cross_found_one'] = 'Funnet';
$string[ 'grade'] = 'Grad';

//cross/play.php
$string[ 'cross_across'] = 'Tvärs';
$string[ 'cross_checkbutton'] = 'Kontrollera Lathund';
$string[ 'cross_down'] = 'Ned';
$string[ 'cross_endofgamebutton'] = 'End Game';
$string[ 'cross_error_containsbadchars'] = 'Ordet innehåller illegala Characteres';
$string[ 'cross_error_wordlength1'] = 'Rätt ord innehåller ';
$string[ 'cross_error_wordlength2'] = ' bokstäver.';
$string[ 'cross_pleasewait'] = 'Vänta medan korset är lastning';
$string[ 'cross_welcome'] = '<h3>Välkommen!</h3><p>Klicka på ett ord för att börja.</p>';
...
//view.php
$string[ 'attemptgamenow'] = 'Försök spelet nu';
$string[ 'comment'] = 'Comment';
$string[ 'continueattemptgame'] = 'Fortsätta ett tidigare försök med spel';
...
$string[ 'reattemptgame'] = 'åter försöka spel';
