...
$string[ 'and'] = 've';
$string[ 'cross_correct'] = 'doğru';
$string[ 'cross_corrects'] = 'düzeltir';
$string[ 'cross_error'] = 'hata';
$string[ 'cross_errors'] = 'hataları';
$string[ 'cross_found_many'] = 'bulundu';
$string[ 'cross_found_one'] = 'bulundu';
$string[ 'grade'] = 'sınıf';

//cross/play.php
$string[ 'cross_across'] = 'arasında';
$string[ 'cross_checkbutton'] = 'Crossword edin';
$string[ 'cross_down'] = 'aşağı';
$string[ 'cross_endofgamebutton'] = 'uç Oyunu';
$string[ 'cross_error_containsbadchars'] = 'Kelime kaçak parametreleri; içerir';
$string[ 'cross_error_wordlength1'] = 'Doğru sözcük içeriyor ';
$string[ 'cross_error_wordlength2'] = ' harfler.';
$string[ 'cross_pleasewait'] = 'Çapraz yüklenirken lütfen bekleyin';
$string[ 'cross_welcome'] = '<h3>Hoşgeldiniz!</h3><p>Başlamak için bir kelime tıklayın.</p>';
$string[ 'letter'] = 'mektup';
$string[ 'letters'] = 'harfler';
$string[ 'nextgame'] = 'Yeni oyun';
$string[ 'no_words'] = 'Hiçbir kelime vardır';
$string[ 'print'] = 'Yazdır';
...
//view.php
$string[ 'attemptgamenow'] = 'Oyunun bir önceki girişimlerini devam';
$string[ 'comment'] = 'Comment';
$string[ 'continueattemptgame'] = 'Oyunun bir önceki girişimlerini devam';
...
$string[ 'reattemptgame'] = 'reattempt oyunu';
