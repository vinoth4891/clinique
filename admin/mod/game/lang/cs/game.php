...
$string[ 'and'] = 'a';
$string[ 'cross_correct'] = 'správné';
$string[ 'cross_corrects'] = 'koriguje';
$string[ 'cross_error'] = 'chyba';
$string[ 'cross_errors'] = 'chyby';
$string[ 'cross_found_many'] = 'nalezeno';
$string[ 'cross_found_one'] = 'nalezeno';
$string[ 'grade'] = 'stupeň';

//cross/play.php
$string[ 'cross_across'] = 'přes';
$string[ 'cross_checkbutton'] = 'Zkontrolujte, křížovka';
$string[ 'cross_down'] = 'dolů';
$string[ 'cross_endofgamebutton'] = 'konec hry';
$string[ 'cross_error_containsbadchars'] = 'Slovo obsahuje nepovolené hrdinka';
$string[ 'cross_error_wordlength1'] = 'Správné slovo obsahuje ';
$string[ 'cross_error_wordlength2'] = ' dopisy.';
$string[ 'cross_pleasewait'] = 'Počkejte prosím, než kříž se načítá';
$string[ 'cross_welcome'] = '<h3>Vítejte!</h3><p>Klikněte na slovo k zahájení.</p>';
$string[ 'letter'] = 'dopis';
$string[ 'letters'] = 'dopisy';
$string[ 'nextgame'] = 'Nová hra';
$string[ 'no_words'] = 'Neexistují slova';
$string[ 'print'] = 'Tisk';
$string[ 'win'] = 'Blahopřejeme !!!';
...
$string[ 'timecompleted'] = 'dokončený';
...
//view.php
$string[ 'attemptgamenow'] = 'Pokus hra nyní';
$string[ 'comment'] = 'Comment';
$string[ 'continueattemptgame'] = 'Pokračovat předchozí pokus o hře';
...
$string[ 'reattemptgame'] = 'Reattempt hra';
