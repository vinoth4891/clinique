...
$string[ 'and'] = 'และ';
$string[ 'cross_correct'] = 'ที่ถูกต้อง';
$string[ 'cross_corrects'] = 'ติเตียน';
$string[ 'cross_error'] = 'ข้อผิดพลาด';
$string[ 'cross_errors'] = 'ข้อผิดพลาด';
$string[ 'cross_found_many'] = 'พบ';
$string[ 'cross_found_one'] = 'พบ';
$string[ 'grade'] = 'ชั้นประถมศึกษาปี';

//cross/play.php
$string[ 'cross_across'] = 'ทั่ว';
$string[ 'cross_checkbutton'] = 'ตรวจสอบ Crossword';
$string[ 'cross_down'] = 'ลง';
$string[ 'cross_endofgamebutton'] = 'ท้ายเกม';
$string[ 'cross_error_containsbadchars'] = 'คำที่มีลักษณะที่ผิดกฎหมาย';
$string[ 'cross_error_wordlength1'] = 'คำที่ถูกต้องมี ';
$string[ 'cross_error_wordlength2'] = ' ตัวอักษร.';
$string[ 'cross_pleasewait'] = 'โปรดรอสักครู่ในขณะที่ข้ามมีการโหลด';
$string[ 'cross_welcome'] = '<h3>ยินดีต้อนรับคุณ!</h3><p>คลิกที่คำที่จะเริ่มต้น.</p>';
$string[ 'letter'] = 'จดหมาย';
$string[ 'letters'] = 'ตัวอักษร';
$string[ 'nextgame'] = 'เกมใหม่';
$string[ 'no_words'] = 'ไม่มีคำพูด';
$string[ 'print'] = 'พิมพ์';
$string[ 'win'] = 'ขอแสดงความยินดี !!!';
...
//view.php
$string[ 'attemptgamenow'] = 'เกมความพยายามตอนนี้';
$string[ 'comment'] = 'Comment';
$string[ 'continueattemptgame'] = 'ดำเนินการต่อความพยายามก่อนหน้าของเกม';
