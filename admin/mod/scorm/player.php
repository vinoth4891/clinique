...
?>
	...
	<script>
		...
		console.info("resize started");
		//jQuery(window.parent.document).find("#courseContent-iframe").css('width','90%').css('margin-right','0px').css('margin-left','0px');
		
		jQuery('.content-primary').css('width','100% ').css('margin-right','0');
		jQuery('#scorm_object').css('width','100%').css('margin-right','0');
		jQuery('#scorm_layout').css('width','100%').css('margin-right','0');
		$(window).trigger('resize');
		console.info("resize end");
		
		setTimeout(function(){ 
		  //jQuery(window.parent.document).find("#courseContent-iframe").css('width','94%').css('margin-right','0px').css('margin-left','0px');
		  jQuery('.content-primary').css('width','100% ').css('margin-right','0');
		  jQuery('#scorm_object').css('width','100%').css('margin-right','0');
		   jQuery('#scorm_layout').css('width','100%').css('margin-right','0');
			$(window).trigger('resize');
		...
		setTimeout(function(){ 
		  //jQuery(window.parent.document).find("#courseContent-iframe").css('width','98%').css('margin-right','0px').css('margin-left','0px').css('float', 'left');
		  jQuery('.content-primary').css('width','100% ').css('margin-right','0');
		  jQuery('#scorm_object').css('width','100%').css('margin-right','0');
		   jQuery('#scorm_layout').css('width','100%').css('margin-right','0');
		   $(window).trigger('resize');
		...
		div.yui-layout-bd.yui-layout-bd-nohd.yui-layout-bd-noft { border:0px !important;}
		.yui-skin-sam .yui-layout{background:#ffffff !important;}
...
/* 			#scorm_layout{
			...
			.yui-layout-doc, .yui-layout-doc .yui-layout-unit,  .yui-layout-doc .yui-layout-unit .yui-layout-wrap, .yui-layout-doc div, #scorm_object
			 {  width:100% !important;}
			.yui-layout-doc .yui-layout-unit { left:0 !important;}
			#scorm_layout, #scorm_object, #scorm_content{ height:227px !important; }
			div.yui-layout-bd.yui-layout-bd-nohd.yui-layout-bd-noft { border:0px !important;}
		}
		@media handheld, only screen and (max-width: 360px){
		   ...
		   .ui-content { padding:0 !important;}
			.yui-layout-doc, .yui-layout-doc .yui-layout-unit,  .yui-layout-doc .yui-layout-unit .yui-layout-wrap, .yui-layout-doc div, #scorm_object
			 {  width:100% !important;}
			.yui-layout-doc .yui-layout-unit { left:0 !important;}
			#scorm_layout, #scorm_object, #scorm_content{ height:100% !important; }
			div.yui-layout-bd.yui-layout-bd-nohd.yui-layout-bd-noft { border:0px !important;}
		}
