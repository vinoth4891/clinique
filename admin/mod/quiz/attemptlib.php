...
class quiz_attempt {
     ...
     */
    public function process_submitted_actions($timestamp, $becomingoverdue = false, $postarray = null) {
        global $DB;

        $transaction = $DB->start_delegated_transaction(); 

        $this->quba->process_all_actions($timestamp, $postarray);
    ...
    public function process_finish($timestamp, $processsubmitted, $postarray = null) {
        global $DB;
