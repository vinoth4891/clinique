...
$temp->add(new admin_setting_configselect('sessiontimeout', new lang_string('sessiontimeout', 'admin'), new lang_string('configsessiontimeout', 'admin'), 7200, array(86400 => new lang_string('numhours', '', 24),14400 => new lang_string('numhours', '', 4),
