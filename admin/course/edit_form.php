...
//--------------------------------------------------------------------------------
		...
		$mform->addElement('select', 'viewtype', get_string('viewtype'), array('0' => 'Accordion', '1' => 'Tiling'));
		
		$mform->addElement('editor','coursepreview_editor', get_string('coursepreview'), null, $editoroptions);
		$mform->addHelpButton('coursepreview_editor', 'coursepreview');
        $mform->setType('coursepreview_editor', PARAM_RAW);
