...
if (!empty($course)) {
	...
	$course = file_prepare_standard_editor($course, 'coursepreview', $editoroptions, $coursecontext, 'course', 'coursepreview', 0);
	...
	$course = file_prepare_standard_editor($course, 'coursepreview', $editoroptions, null, 'course', 'coursepreview', null);
}
