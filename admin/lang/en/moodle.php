...
A new account and temporary password have been created for you on the Clinique Dramatically Different eLearning Experience.

The Dramatically Different eLearning Experience is your opportunity to learn about new and existing Clinique products in a fun, engaging way that will also allow you to be a part of the global Clinique community of Consultants and Generic Staff.

Our first module is all about the biggest launch Clinique has ever had. Curious? Click below and get started to find out what it is!

If you are accessing via your iOS device click here:
http://clinique-dev-ios.photon.com
 
If you are accessing via your Android device click here:
http://clinique-dev-droid.photon.com
 
If you are accessing via Blackberry click here:
http://clinique-dev-bb.photon.com
 
If you are accessing via your Mac or PC click here:
http://clinique-dev-pc.photon.com

Your user name is: {$a->username}
Your temporary password is: {$a->newpassword}
(You will be prompted to change your password when you first log in.)

If the above links do not work, please copy and paste the appropriate address into your browser window and press Enter.

Welcome to your Dramatically Different eLearning Experience!

Clinique Education
cliniquedev@clinique.com';
...
$string['key'] = 'Key';
$string['sectionposition'] = 'Section position';
$string['invalidsectionposition'] = 'Invalid section position';
$string['sectionlogo'] = 'Section logo';
$string['subadminregionlist'] = 'Subadmin list';
$string['assignnewsubadmin'] = 'Assign Subadmin language';
$string['selectsubadmin'] = 'Select SubAdmin';
$string['selectregion'] = 'Select Region';
$string['addedcountry'] = 'Added country';
$string['editprofile'] = 'Edit Profile';
$string['enroledusers'] = 'Enrolled Users';
$string['enrolusers'] = 'Enroll New User';
$string['browseusers'] = 'Browse Users';
$string['adduser'] = 'Add User';
$string['uploadbulkuser'] = 'Upload Bulk Users';
$string['assignedlanguages'] = 'Assigned Languages';
$string['viewtype'] = 'View Type';
$string['folderlist'] = 'Folder List';
$string['courselist'] = 'Course List';
$string['goback'] = 'Go Back';
$string['nocoursefound'] = 'No Course found';
$string['nofoldersfound'] = 'No Folders found';
$string['coursepreview'] = 'Course preview';
$string['coursepreview'] = 'Course preview - Optimal file size is 1MB (Files above optimal size may effect performance)';
$string['coursepreview_help'] = 'Optimal file size is 1MB (Files above optimal size may effect performance).';
$string['stores'] = 'Browse Stores';
$string['addstore'] = 'Add Retailer / Store';
$string['editstore'] = 'Edit Retailer / Store';
$string['searchstore'] = 'Search Store';
$string['selectcountry'] = 'Select Country';
$string['selectretailer'] = 'Select Retailer';
$string['store'] = 'Store';
$string['searchretailer'] = 'Search Retailer';
$string['browsestore'] = 'Browse Stores';
$string['deletestore'] = 'Delete Store';
$string['deleteretailer'] = 'Delete Retailer';
$string['storecharlimit'] = 'Store name cannot be greater than 256 characters';
$string['storealphanumeric'] = 'Store name can only contain alphanumeric characters';
$string['retailercharlimit'] = 'Retailer name cannot be greater than 256 characters';
$string['retaileralphanumeric'] = 'Retailer name can only contain alphanumeric characters';
