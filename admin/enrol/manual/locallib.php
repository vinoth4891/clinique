    ...
    public function find_users($search) {
		...
		if($this->currentuserrolename == 'subadmin') {
			...
			if($enrol_ids) {			
				...
				$wherecondition .= "AND ue.userid NOT IN (SELECT userid FROM mdl_user_enrolments WHERE enrolid = ".$this->enrolid.")";
