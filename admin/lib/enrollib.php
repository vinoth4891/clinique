 ...
 * @return array
 */
function enrol_get_users_courses($userid, $categoryid, $cattype, $onlyactive = false, $fields = NULL, $sort = 'visible DESC,sortorder ASC') {
    global $DB;

    $courses = enrol_get_all_users_courses($userid, $categoryid, $cattype, $onlyactive, $fields, $sort);
