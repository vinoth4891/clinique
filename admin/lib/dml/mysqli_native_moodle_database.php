...
class mysqli_native_moodle_database extends moodle_database {
     ...
     */
    public function get_columns($table, $usecache=false) {
     ...
     * @throws dml_exception A DML specific exception is thrown for any errors.
     */
    public function get_records_sp($sql, array $params=null, $limitfrom=0, $limitnum=0) {
     ...
     * @throws dml_exception A DML specific exception is thrown for any errors.
     */
    public function get_records_all_sql($sql, array $params=null, $limitfrom=0, $limitnum=0) {
        $limitfrom = (int)$limitfrom;
        $limitnum  = (int)$limitnum;
        $limitfrom = ($limitfrom < 0) ? 0 : $limitfrom;
        $limitnum  = ($limitnum < 0)  ? 0 : $limitnum;
