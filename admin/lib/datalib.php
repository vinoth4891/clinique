...
function get_users_subadmin($get=true, $search='', $confirmed=false, array $exceptions=null, $sort='u.firstname ASC',
                   $firstinitial='', $lastinitial='', $page='', $recordsperpage='', $fields='*', $extraselect='', array $extraparams=null, $join='') {
    global $DB, $CFG;
...
function get_users_listing_subadmin($sort='lastaccess', $dir='ASC', $page=0, $recordsperpage=0,
                           $search='', $firstinitial='', $lastinitial='', $extraselect='',
                           array $extraparams=null, $extracontext = null, $join = '') {
    global $DB;
