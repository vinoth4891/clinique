...
function get_manual_enrol_by_course($courseid) {
	global $DB;
	$getmanualenrol = $DB->get_record('enrol', array('courseid' => $courseid, 'enrol'=> 'manual'));
	if($getmanualenrol) {
		$getmanualenrolid = $getmanualenrol->id;
	} else {
		$getmanualenrolid = '';
	}
	return $getmanualenrolid;
}
