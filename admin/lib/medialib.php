...
<span class="mediaplugin mediaplugin_qt">
        <!--[if lte IE 8]>
        <object width="60%" height="350px" type="video/x-ms-asf" url=" $url " data="clipcanvas_14348_offline.mp4" classid="CLSID:6BF52A52-394A-11d3-B153-00C04F79FAA6">
            <param name="url" value=" $url "><param name="filename" value=" $url ">
            <param name="autostart" value="1"><param name="uiMode" value="full">
            <param name="autosize" value="1"><param name="playcount" value="1">
            <embed type="application/x-mplayer2" src=" $url " width="100%" height="100%" autostart="true" showcontrols="true" pluginspage="http://www.microsoft.com/Windows/MediaPlayer/">
            </embed>
        </object> 
        <![endif]-->
        <!--[if !IE]>-->
