...
#endif
// Dev
//Service urls http://172.16.17.42/cliniquedev/admin/v2/clinique_webservice/services.php
#define kServiceUrl @"http://172.16.17.42/clinique/admin/v2/clinique_webservice/services.php"
#define kSyncServiceUrl @"http://172.16.17.42/clinique/admin/v2/clinique_webservice/sync_service.php"
#define kContentDownloadUrl @"http://172.16.17.42/clinique/admin/webservice/pluginfile.php?"
#define kTermsAndConditionUrl @"http://172.16.17.42/clinique/language/%@/Clinique_Education_Terms_And_Conditions_WEBSITE_%@.docx"
#define kPrivacyPolicyUrl @"http://172.16.17.42/clinique/language/%@/Clinique_Education_Privacy_Policy_WEBSITE_%@.docx"
	

//Cloud
/*#define  kServiceUrl @"http://54.225.106.255/clinique/admin/v2/clinique_webservice/services.php"
#define kSyncServiceUrl @"http://54.225.106.255/clinique/admin/v2/clinique_webservice/sync_service.php"
#define kContentDownloadUrl @"http://54.225.106.255/clinique/admin/webservice/pluginfile.php?"
#define kTermsAndConditionUrl @"http://54.225.106.255/clinique/language/%@/Clinique_Education_Terms_And_Conditions_WEBSITE_%@.docx"
#define kPrivacyPolicyUrl @"http://54.225.106.255/clinique/language/%@/Clinique_Education_Privacy_Policy_WEBSITE_%@.docx"*/
