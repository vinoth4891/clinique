...
@property (strong, nonatomic)NSTimer *singleModeTimer;
@property (assign, nonatomic)BOOL isAppQuitFromBlueOcean;
//@property (strong, nonatomic)NSTimer *singleModeUnlockTimer;
