...
- (void) openPdf:(CDVInvokedUrlCommand*)sender
{
    ...
    @try {
        ...
        //[CacheManager defaultManager].currentCache.pdfUrl  = [NSURL URLWithString:[[CacheManager defaultManager].currentCache.pdfFilePath stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding]];
        [CacheManager defaultManager].currentCache.pdfUrl  = [NSURL URLWithString:[CacheManager defaultManager].currentCache.pdfFilePath];
