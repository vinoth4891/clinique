...
import com.clinique.phresco.hybrid.activity.FileOpener;
import com.clinique.phresco.hybrid.R;

public class MuPDFOnlineActivity extends Activity implements OnClickListener, OnCheckedChangeListener {
	...
	class DeleteBookmark extends AsyncTask<Void, Void, Void> {
		...
		protected void onPreExecute() {
			...
			loading = new ProgressDialog(MuPDFOnlineActivity.this);
	...
	class GetBookmark extends AsyncTask<Void, Void, Void> {
	...
	class InsertBookmark extends AsyncTask<Void, Void, Void> {
	...
	public void createUI(Bundle savedInstanceState) {
		...
		if (Utilities.hasActiveInternetConnection(MuPDFOnlineActivity.this)) {
			new GetBookmark().execute();
		} else {
			Utilities.AlertView(MuPDFOnlineActivity.this);
		}
	...
	public void onClick(View v) {
		...
		case R.id.btnDone:
			...
			break;
		case R.id.btnNotes:
			final Dialog pgDialog = new Dialog(MuPDFOnlineActivity.this);
			...
			pgDone.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					pgDialog.cancel();
					if (Utilities.hasActiveInternetConnection(MuPDFOnlineActivity.this)) {
						new InsertComment().execute(pgNumber.getText().toString());
					} else {
						Utilities.AlertView(MuPDFOnlineActivity.this);
					}
		...
		case R.id.btnThumbnail:
			if (bitmap == null || bitmap.isEmpty()) {
				...
				Intent intent = new Intent(MuPDFOnlineActivity.this, Thumb.class);
		...
		case R.id.pageNumber:
			final Dialog pageNumberDialog = new Dialog(MuPDFOnlineActivity.this);
		...
		case R.id.btnDownload:
			...
			if (Environment.MEDIA_MOUNTED.equals(state)) {
				...
				Utilities.AlertView(MuPDFOnlineActivity.this, getResources().getString(R.string.no_sdcard));
			}
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (core == null) {
			...
			mAlertBuilder = new Dialog(MuPDFOnlineActivity.this);
	...
	public void requestPassword(final Bundle savedInstanceState) {
		...
		AlertDialog.Builder mBuilder = new AlertDialog.Builder(MuPDFOnlineActivity.this);
