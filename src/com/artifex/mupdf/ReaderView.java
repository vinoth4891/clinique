...
public class ReaderView extends AdapterView<Adapter> implements GestureDetector.OnGestureListener, ScaleGestureDetector.OnScaleGestureListener, Runnable {
	...
	private int							mCurrent;										// Adapter's
																						// index
																						// for
																						// the
																						// current
	...
	private boolean						mUserInteracting;								// Whether
																						// the
																						// user
																						// is
																						// interacting
	private boolean						mScaling;										// Whether
																						// the
																						// user
																						// is
																						// currently
	...
	private int							mXScroll;										// Scroll
																						// amounts
																						// recorded
																						// from
																						// events.
	private int							mYScroll;										// and
																						// then
																						// accounted
																						// for
																						// in
