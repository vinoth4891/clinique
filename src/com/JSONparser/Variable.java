...
public class Variable {
	...
	public static String	PUBLIC_STORAGE	= (MainActivity.context.getExternalFilesDir("Clinique")).getAbsolutePath();//"/storage/emulated/0/Clinique";
	public static String	SECURE_STORAGE	= (MainActivity.context.getExternalFilesDir("Clinique")).getAbsolutePath();
