...
//            jQuery(".iframewrap_crs_res").prepend('<div class="ifram_cls_btn close"><span><img src="../images/closebtn.png"></span></div>');
        ...
        resourceSuccess: function (res){
            var kellyItems, modules, kellyli, resFileName, resFileType,deviceContents;
            ...
            jQuery("#resourceContent-iframe").load(function() {
                ...
                jQuery(this).show();
					if(Filetype === 'quiz'){
							...
							if ( browserVersion ) {
								jQuery("#resourceContent-iframe").contents().find(".submitbtns span.ui-btn-corner-all, .quizattempt span.ui-btn-corner-all, .gameattempt span.ui-btn-corner-all, .continuebutton span.ui-btn-corner-all").css('filter','progid:DXImageTransform.Microsoft.gradient( startColorstr="#ffffff", endColorstr="#c2c2c2",GradientType=0 ); /* IE6-8 */;');
							}
