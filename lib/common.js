var languages = {
	...
	"en_cm" : "English - Counter Manager",//English - Counter Manager
	"en_ap" : "English - Asia Pacific",//English - Asian
...
function headFootCtrl(){
    if(!isDevice()){
       if((jQuery(this).width() >= 1000) && !(navigator.platform.match(/iPad/i))){
			...
			if ( $.browser.msie && parseInt($.browser.version, 10) === 7 && ( $('body').hasClass('quiz-main-container') || $('body').hasClass('scormPage')) ) {
